...
import IcSearch20 from "@/assets/icons/Search20";
...
const CommandEmpty = React.forwardRef((props, ref) => (
  <CommandPrimitive.Empty
    ref={ref}
    className="py-6 text-center text-subheadline text-text-secondary"
    {...props}
  />
));
...
const CommandItem = React.forwardRef(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex h-12 cursor-default select-none items-center rounded px-3 text-body outline-none data-[disabled=true]:pointer-events-none data-[selected=true]:bg-red-6 data-[selected=true]:text-text-secondary data-[disabled=true]:opacity-50",
      className,
    )}
    {...props}
  />
